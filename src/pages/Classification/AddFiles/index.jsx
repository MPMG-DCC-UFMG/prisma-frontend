...
export default function ClassificationAddFiles(props) {
    ...
    const sendFiles = async () => {
        ...
        files.forEach(async (file) => {
            await ApiRequest.setUrl(BaseUrls.CLASSIFICATION_UPLOAD, params).post(null, file);
        });
        setTimeout(() => {
            history.push(`/case/${params.projectId}/classification`);
            setSending(false);
        }, 1000)
    }
