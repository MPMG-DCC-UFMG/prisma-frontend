        ...
        <>
          {currentCase.open ? (
            <div className="row mt-1">
              ...
              {currentCase.has_image ? (
                <div className="col-xs">
                  <ImageTranscriptionCard currentCase={currentCase} />
                </div>
              ) : null}
            ...
            <Empty
              description="CASO FECHADO"
              image="https://cdn4.iconfinder.com/data/icons/internet-security-flat-2/32/Internet_Security_folder_Archive_lock_locked_private-256.png"
            ></Empty>
          )}
        </>
      ) : null}
