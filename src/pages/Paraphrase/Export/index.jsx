...
export default function ParaphraseExport(props) {
    ...
    const onFinish = async (values) => {
        setSending(true);
        const zip = await ApiRequest.setUrl(`${BaseUrls.PARAPHRASE_EXPORT}?${new URLSearchParams(values).toString()}`, params).get();
                ...
                <div className="col-xs-12 col-md-6 ta-l">
                    ...
                    >
                        ...
                        >
                            ...
                            <Form.Item
                                label="Apenas parafráses aprovadas"
